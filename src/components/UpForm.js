...
<section class="h-screen pt-5 bg-gray-100/50 border">
            ...
            <div class="max-w-sm mx-auto md:w-full md:mx-0">
                <div class="inline-flex items-center space-x-4">
                    <a href="#" class="relative block">
                        <img alt="profil" src={avatar} class="mx-auto object-cover rounded-full h-16 w-16 "/>
                    </a>
        ...
        <div class="space-y-6 bg-white">
            <div class="items-center w-full p-4 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
                ...
                <div class="max-w-sm mx-auto md:w-2/3">
                    <div class=" relative ">
                        <input type="file" id="user-info-file" class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="upload file"/>
                        </div>
                    </div>
                </div>
                <hr/>
