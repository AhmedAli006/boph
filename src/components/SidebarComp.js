  ...
  return (
    <>
      <button
        ...
        type="button"
        class="inline-flex items-center p-2 mt-2 ms-3 text-sm txtwhite rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
      >
