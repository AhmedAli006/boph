  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm txtwhite rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
      >
      ...
      <aside
        id="default-sidebar"
        style={{ backgroundColor: "#00072D", fontFamily: "meshed" }}
        className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto">
          <div
            className="rounded-full ml-6 mt-10"
            style={{
              display: "flex",
